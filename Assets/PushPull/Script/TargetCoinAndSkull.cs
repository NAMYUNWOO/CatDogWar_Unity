...
public class TargetCoinAndSkull : MonoBehaviour {
	...
	void OnCollisionEnter2D(Collision2D collider){
		if ((collider.gameObject.tag == "Player" || collider.gameObject.tag == "Enemy")&& gameObject.tag == "TargetCoin") {
			/*
			...
			*/
			...
			mgm.ScoreCounter (gameObject.tag == "TargetCoin", collider.gameObject.tag == "Player");
